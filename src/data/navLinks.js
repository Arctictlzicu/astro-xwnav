...
    id: 'digitalvirt',
    title: 'DigitalVirt',
    description: 'DigitalVirt 是一家提供高性能VPS和独立服务器的商家，以其优质的网络线路和稳定的服务而受到用户青睐。主要提供香港、日本、美国等地的优化线路，包括CN2 GIA、BGP等，确保低延迟和高速度。产品配置灵活，支持多种操作系统，并提供DDoS防护。',
...
    id: 'bitsflow',
    title: 'BitsFlow',
    description: 'BitsFlow 提供高性能的云服务器和网络解决方案，专注于为用户提供稳定、快速且可扩展的基础设施服务。其特点包括全球数据中心分布、优化的网络连接、灵活的配置选项以及强大的DDoS防护。BitsFlow致力于满足企业级用户和个人开发者对高性能计算和网络服务的需求。',
...
    id: 'bigchick-new',
    title: 'BigChick',
    description: 'BigChick 提供高性价比的VPS服务，专注于提供稳定可靠的虚拟服务器解决方案。其服务特点包括灵活的配置选项、多种数据中心位置以及对多种操作系统的支持。BigChick致力于为个人开发者和中小型企业提供经济实惠且性能优越的VPS产品，以满足不同用户的需求。',
...
    id: 'akile',
    title: 'Akile',
    description: 'Akile 提供高性能的云服务器和网络解决方案，专注于为用户提供稳定、快速且可扩展的基础设施服务。其特点包括全球数据中心分布、优化的网络连接、灵活的配置选项以及强大的DDoS防护。Akile致力于满足企业级用户和个人开发者对高性能计算和网络服务的需求。',
    shortDesc: '高性能云服务器和网络解决方案。',
    url: 'https://akile.io/',
    category: 'vps',
    icon: '/icons/logo.png',
...
    id: 'yin-net',
    title: 'Yin-Net',
    description: 'Yin-Net 提供多种VPS解决方案，专注于为用户提供稳定、可靠的虚拟服务器服务。其特点包括灵活的配置选项、多地域数据中心以及对不同操作系统的支持。Yin-Net致力于满足个人用户和中小型企业对经济高效且性能优越的VPS产品的需求。',
...
    id: 'dataonline',
    title: 'DataOnline',
    description: 'DataOnline 提供越南本地的高性能VPS服务，专注于为东南亚地区用户提供稳定、快速的网络连接和可靠的服务器解决方案。其特点包括优化的本地网络、灵活的配置选项以及对多种操作系统的支持。DataOnline致力于满足当地企业和个人开发者对高性能计算和网络服务的需求。',
...
    id: 'yecaoyun',
    title: '野草云',
    description: '野草云提供高性价比的VPS和独立服务器，专注于为用户提供稳定、快速且可扩展的基础设施服务。其特点包括全球数据中心分布、优化的网络连接、灵活的配置选项以及强大的DDoS防护。野草云致力于满足企业级用户和个人开发者对高性能计算和网络服务的需求。',
...
    id: 'claw-cloud',
    title: 'Claw.Cloud',
    description: 'Claw.Cloud 提供高性能的云服务器和网络解决方案，专注于为用户提供稳定、快速且可扩展的基础设施服务。其特点包括全球数据中心分布、优化的网络连接、灵活的配置选项以及强大的DDoS防护。Claw.Cloud致力于满足企业级用户和个人开发者对高性能计算和网络服务的需求。',
    shortDesc: '高性能云服务器和网络解决方案。',
...
    id: 'vps-town',
    title: 'VPS.Town',
    description: 'VPS.Town 提供高性价比的VPS服务，专注于为用户提供稳定可靠的虚拟服务器解决方案。其服务特点包括灵活的配置选项、多种数据中心位置以及对多种操作系统的支持。VPS.Town致力于为个人开发者和中小型企业提供经济实惠且性能优越的VPS产品，以满足不同用户的需求。',
    shortDesc: '高性价比VPS服务提供商。',
    url: 'https://vps.town/',
    category: 'vps',
    icon: '/icons/logo.png',
